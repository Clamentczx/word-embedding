...
def main():
    ...
    sk_bow_trainer = Trainer(train_label=train_data[0], train_sentence=sk_sent_rep_BOW_train, 
                         dev_label=dev_data[0], dev_sentence=sk_sent_rep_BOW_dev, 
                         test_label=test_data[0], test_sentence=sk_sent_rep_BOW_test, 
                         input_size=300, hidden_size=640, batch_size=128, learning_rate=7e-4, num_epochs=30)
    
    sk_bow_trainer.train()
    sk_bow_trainer.test()
    ...
    gl_bow_trainer = Trainer(train_label=train_data[0], train_sentence=gl_sent_rep_BOW_train, 
                         ...
                         input_size=300, hidden_size=720, batch_size=128, learning_rate=7e-4, num_epochs=10)
